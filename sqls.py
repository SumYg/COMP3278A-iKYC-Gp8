...
def getHKDSavingAccount():
    """
    Return account_number, currency, amount in Saving
    """
    query = f"SELECT S.account_number, S.currency, S.amount FROM Account A, Saving S WHERE A.account_number = S.account_number AND A.username = '{USER_NAME}' AND S.currency = 'HKD'"
    mycursor.execute(query)
...
def getCreditAccount():
    """
    Return account_number, available_credit, remaining_credit in Credit
    """
...
def getInvestAccount():
    """
    Return account number, amount in Investment of the user
    """
...
def getOwnerOfAccount(accNo):
    """
    Return username (owner of the account)
    """
...
#checkTransAmountFromSaving(getHKDSavingAccount()[0], 1000)
#countTrans()
#makeTransFromSaving(getHKDSavingAccount()[0], '00000001', 200)
